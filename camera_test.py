...
class MotionRecorder(object):
    ...
    cap = cv2.VideoCapture("v4l2src device=device_num ! video/x-raw, width=640, height=480, framerate=60/1, format=(string)UYVY ! decodebin ! videoconvert ! appsink", cv2.CAP_GSTREAMER)
